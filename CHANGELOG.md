...
* Introduced a new `exclude_xsrf_token_cookie` class method to exclude setting CSRF token for certain controllers. This is done to care of [problems with streaming](https://github.com/jsanders/angular_rails_csrf/issues/7).
